...
namespace Event_Management_System
{
    public partial class Reg_Update : System.Web.UI.Page
    {
        ...
        {
            String sel = "select Name,Address,Contact_no,Email,Username,Password,Con_password from Reg1 where id='" + txtid.Text + "'";
        ...
        {
            String update = "update Reg1 set Name='" + txtname.Text + "',Address='" + txtadd.Text + "',Contact_no='" + txtcontact.Text + "',Email='" + txtemail.Text + "',Username='" + txtuname.Text + "',Password='" + txtpass.Text + "',Con_password='" + txtconpass.Text + "' where id='" + txtid.Text + "'";
